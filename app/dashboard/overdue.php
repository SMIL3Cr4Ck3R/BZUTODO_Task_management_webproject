        ...
        HTML;           
                            if ($lateTasks !=null){
                                ...
                                foreach ($lateTasks as $key => $task) {
                                    ...
                                    echo "<td class=\"late\">High</td>";
                                    echo "<td class=\"late\">{$task['task_status']}</td>";
                                ...
                                echo "<tr><td colspan=\"6\">NO DUE TASKS  :D</td></tr>";
            echo <<<HTML
                        </tbody>
                    </table>
                </div>
