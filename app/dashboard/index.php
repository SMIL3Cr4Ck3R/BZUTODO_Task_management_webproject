...
if (array_key_exists("success", $_GET) && $_GET['success'] === "verified" || isset($_SESSION['userId'])) {
    ...
    echo <<<HTML
        ...
        <body>
            ...
            <main class="main-section">
                <h1>Welcome Back! <span>{$loggedUser['member_name']}</span></h1>
...
function checkStatus ($statusClass) {

    global $task;

    if ($task['task_priority'] === '1') {
        echo "<td class=\"$statusClass\">Low</td>";
        echo "<td class=\"$statusClass\">{$task['task_status']}</td>";
        
    }else if ($task['task_priority'] === '2') {
        echo "<td class=\"$statusClass\">Medium</td>";
        echo "<td class=\"$statusClass\">{$task['task_status']}</td>";
        
    }else if ($task['task_priority'] === '3') {
        echo "<td class=\"$statusClass\">High</td>";
        echo "<td class=\"$statusClass\">{$task['task_status']}</td>";
